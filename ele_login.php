...
<?php include"menubar.php"; ?>
		...
		<div class="login" style="text-align: center;">
			<h3 class="heading" style="color: white;">Electrician Login</h3>
			<div class="log"  >
			<?php
				if(isset($_POST["login"]))
				{
					$sql="select * from electrician where MAIL='{$_POST["mail"]}' and PASSWORD='{$_POST["password"]}'";
					$res=$db->query($sql);
					if($res->num_rows>0)
					{
						$ro=$res->fetch_assoc();
						...
						echo "<script>window.open('e_view.php','_self');</script>";
					}
					else
					{
			...
			?>
				...
				<form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
					...
					<a href="forgotpassword.php" > Forgot password?</a>
                                        <br>
                                        <a href="ele_signup.php" > <b>SIGNUP</b></a>
